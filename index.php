          ...
          <div class="row justify-content-between">
            <div class="col-xxl-6 col-xl-6 col-lg-6 my-auto">
              <div class="hero-caption-one mb-20">
                <!--<h4 class="key-title font-700 mb-20 wow fadeInUp" data-wow-delay="0.0s">Introducing</h4>-->
                <!--<h4 class="key-title font-700 mb-20 wow fadeInUp text-danger text-capitalize" data-wow-delay="0.0s">DG approved diagnostic center.</h4>-->
                <!--<p class="per wow fadeInUp text-danger fw-bold fs-5">DG approved diagnostic center.</p>-->
                <h1 class="title font-700 wow fadeInUp" data-wow-delay="0.1s">WELCOME TO THE <br><span style="color: #145473;">DELHI MRI SCAN</span></h1>
                <p class="pera wow fadeInUp" data-wow-delay="0.3s" style="color: black;">Delhi MRI Scan, a unit of Sahyog Imaging Company, welcomes you to our advanced diagnostic center located at M-2, Hauz Khas,.<br> New Delhi - 110016. We specialize in providing cutting-edge MRI, CT scan and Ultrasound etc. services to ensure accurate diagnosis and superior patient care.<br>
               </p>
                <div class="d-flex gap-20 flex-wrap">
                  <a href="services.php" class="btn-primary-fill hero-btn wow fadeInLeft" data-wow-delay="0.4s">Know more services</a>
                  <a href="contact-us.php" class="btn-tertiary-fill hero-btn wow fadeInRight" data-wow-delay="0.4s">Contact Us</a>
                </div>
              </div>
            </div>
            <div class="col-xxl-6 col-xl-6 col-lg-6">
              <div class="d-flex gap-44">
                <div class="hero-image position-relative d-none d-lg-block ">
                  <img src="assets/images/hero/hero-img1.png" alt="img" class="w-100 tilt-effect wow fadeInUp rounded" data-wow-delay="0.1s">
                </div>
            ...
            <div class="col-xl-6 col-md-6 col-lg-6 d-flex">
              <div class="helpful-card wow fadeInUp w-100" data-wow-delay="0.0s">
                ...
                <div class="helpful-card-caption">
                  ...
                  <p class="caption-para">Providing comprehensive medical examinations for seafarers as per DG Shipping, IMO, ILO, and MLC guidelines.</p>
                  <a href="dgapprove.php" class="imp-link">Read More <i class="ri-arrow-right-up-line"></i></a>
                </div>
            ...
            <div class="col-xl-6 col-md-6 col-lg-6 d-flex">
              <div class="helpful-card wow fadeInUp w-100" data-wow-delay="0.10s">
                ...
                <div class="helpful-card-caption">
                  ...
                  <p class="caption-para">Our clinic meets the highest standards of healthcare quality and patient safety as set by the National Accreditation Board for Hospitals & Healthcare Providers (NABH).</p>
        ...
        <div class="row g-24 justify-content-between">
          <div class="col-xl-6 col-lg-6">
            <div class="section-tittle mb-50">
              ...
              <p class="pera"> Discover excellence in diagnostic imaging at Delhi MRI Scan, a premier unit of Sahyog Imaging Company. Located in the heart of New Delhi at M-2, Hauz Khas, we are committed to delivering accurate diagnoses and superior patient care through state-of-the-art technology and a team of expert radiologists.</p>
            </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-10 mb-20">
                  <div class="d-flex gap-20">
                    ...
                    <div class="info-content">
                      <h4 class="title">Delhi MRI Scan</h4>
                      <p class="pera">Equipped with advanced Siemens MRI and CT scan technology.</p>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-4 p-0 xs-p-12">
            <div class="image-right-card">
              <div class="tab-section tab-section-one" id="tab-section-one">
                ...
                <div>
                  <p class="subtitle">Our facility is always ready to handle urgent diagnostic needs with advanced technology and skilled professionals.</p>
                </div>
              ...
              <div class="flex justify-content-center mt-30">
                <div class="tab-btn">
                  <a href="javascript:void(0)" class="urgent-tab active" data-tab-id="tab-section-one">Details</a>
                  <a href="javascript:void(0)" class="urgent-tab" data-tab-id="tab-section-two">Contact Us</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-lg-7 my-auto">
            ...
            <div class="section-tittle mb-50">
              ...
              <p class="pera">Feel free to reach out to us if you have any questions about our services, appointments, or procedures. We're here to help!</p>
            </div>
            <div class="accordion" id="accordionExample">
              <div class="accordion-item">
                <h2 class="accordion-header" id="headingOne">
                  <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">How do I schedule an appointment?</button>
                </h2>
                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                  <div class="accordion-body">You can schedule an appointment by calling our center directly at +011 1146183333,+91 9667554447 or by filling out the appointment form on our website.</div>
                </div>
              </div>

              <div class="accordion-item">
                <h2 class="accordion-header" id="headingTwo">
                  <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">What should I bring to my appointment?</button>
                </h2>
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                  <div class="accordion-body">Please bring any relevant medical records, insurance information, and a valid ID. If you have previous imaging scans, it's helpful to bring those as well.</div>
                </div>
              </div>

              <div class="accordion-item">
                <h2 class="accordion-header" id="headingThree">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">How long does an MRI or CT scan take?</button>
                </h2>
                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                  <div class="accordion-body">The duration of an MRI or CT scan can vary depending on the type of scan and area being examined. Generally, scans take between 30 minutes to an hour.</div>
                </div>
              </div>

              <div class="accordion-item">
                <h2 class="accordion-header" id="headingFour">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">Is the radiation exposure from a CT scan harmful?</button>
                </h2>
                <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                  <div class="accordion-body">While CT scans do involve radiation, the amount is typically considered safe. Our equipment is calibrated to minimize radiation exposure while still providing high-quality images.</div>
                </div>
              </div>

              <div class="accordion-item">
                <h2 class="accordion-header" id="headingFive">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">Are there any special preparations required for specific tests?</button>
                </h2>
                <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#accordionExample">
                  <div class="accordion-body">Some tests may require fasting or specific preparations. Our staff will provide you with detailed instructions when you schedule your appointment to ensure you're adequately prepared for your test.</div>
                </div>
              </div>
                  ...
                  <div class="col-xl-3 col-md-6 col-lg-6 d-flex">
                    <div class="helpful-card wow fadeInUp" data-wow-delay="0.0s">
                      ...
                      <div class="helpful-card-caption">
                        ...
                        <p class="caption-para">MRI 3 Tesla, CT Scan, Digital X-Ray, Clinical Pathology Collection Centre, DEXA Bone Densitometry, Ultrasound & Colour Doppler, Clinical Pathology Collection Centre</p>
                        <a href="services.php?category=Radiology" class="imp-link">Read More <i class="ri-arrow-right-up-line"></i></a>
                      </div>
                      <div class="number-watermark">
                        <h4 class="number">01</h4>
                      </div>
                  ...
                  <div class="col-xl-3 col-md-6 col-lg-6 d-flex">
                    <div class="helpful-card wow fadeInUp" data-wow-delay="0.10s">
                      ...
                      <div class="helpful-card-caption">
                        ...
                        <p class="caption-para">URINE ROUTINE, THYROID PROFILE, LFT, HCP PLUS, PSA, KFT</p>
                        <a href="pathology.php" class="imp-link">Read More <i class="ri-arrow-right-up-line"></i></a>
                      </div>
                      <div class="number-watermark">
                        <h4 class="number">02</h4>
                      </div>
                  ...
                  <div class="col-xl-3 col-md-6 col-lg-6 d-flex">
                    <div class="helpful-card wow fadeInUp" data-wow-delay="0.20s">
                      ...
                      <div class="helpful-card-caption">
                        ...
                        <p class="caption-para">EEG (Electroencephalogram), <br> EMG (Electromyography),<br> NCS (Nerve Conduction studies)</p>
                        <a href="services.php?category=Neurology" class="imp-link">Read More <i class="ri-arrow-right-up-line"></i></a>
                      </div>
                      <div class="number-watermark">
                        <h4 class="number">03</h4>
                      </div>
                  ...
                  <div class="col-xl-3 col-md-6 col-lg-6 d-flex">
                    <div class="helpful-card wow fadeInUp" data-wow-delay="0.30s">
                      ...
                      <div class="helpful-card-caption">
                        ...
                        <a href="services.php?category=Cardiology" class="imp-link">Read More <i class="ri-arrow-right-up-line"></i></a>
                      </div>
                      <div class="number-watermark">
                        <h4 class="number">04</h4>
                      </div>
              ...
              <div class="single-testimonial position-relative">
                ...
                <div class="position-absolute quote">
                  <svg xmlns="http://www.w3.org/2000/svg" width="54" height="33" viewBox="0 0 54 33" fill="none">
                    <path opacity="0.25" d="M0 2C0 0.895431 0.895431 0 2 0H20C21.1046 0 22 0.895431 22 2V29.4951C22 31.0437 20.3158 32.0048 18.9825 31.217L0.98254 20.5806C0.373596 20.2208 0 19.5661 0 18.8587V2Z" fill="#00715D" />
                    <path opacity="0.25" d="M32 2C32 0.895431 32.8954 0 34 0H52C53.1046 0 54 0.895431 54 2V29.4951C54 31.0437 52.3158 32.0048 50.9825 31.217L32.9825 20.5806C32.3736 20.2208 32 19.5661 32 18.8587V2Z" fill="#00715D" />
                  </svg>
                </div>
                <div class="position-relative">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 view-wrapper">
              <div class="single-blog h-calc wow fadeInUp" data-wow-delay="0.2s">
                <div class="blog-img position-relative">
                  <a href="blog-details.php?blog_url=<?php echo $row['blog_url']; ?>"> <img src="uploads/blogs/<?php echo $row['image']; ?>" class="img-fluid w-100" alt="img"> </a>
                </div>
                <div class="blog-info">
