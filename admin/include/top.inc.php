        ...
        <div class="navbar-header" data-logobg="skin5">
          <a class="navbar-brand" href="index">
            ...
            <span class="logo-text text-center">
              <img src="../../assets/images/logo/logo02.png" alt="homepage" class="light-logo"  />
            </span>
      ...
      <div class="scroll-sidebar">
        <nav class="sidebar-nav" >
          <ul id="sidebarnav" class="pt-2">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link waves-effect waves-dark sidebar-link" href="manage_about.php" aria-expanded="false"><i class="fas fa-archive"></i>
                <span class="hide-menu">Manage About</span></a>
            </li>
            <li class="sidebar-item">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link waves-effect waves-dark sidebar-link" href="manage_gallery.php" aria-expanded="false"><i class="fas fa-archive"></i>
                <span class="hide-menu">Manage Gallery</span></a>
            </li>
            <li class="sidebar-item">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link waves-effect waves-dark sidebar-link" href="manage_doctors.php" aria-expanded="false"><i class="fas fa-archive"></i>
                <span class="hide-menu">Manage Doctors</span></a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link waves-effect waves-dark sidebar-link" href="manage_contact.php" aria-expanded="false"><i class="fas fa-archive"></i>
            ...
            <!--<li class="sidebar-item">-->
            <!--  <a class="sidebar-link waves-effect waves-dark sidebar-link" href="manage_newslatter.php" aria-expanded="false"><i class="fas fa-archive"></i>-->
            <!--    <span class="hide-menu">Manage Newslatter</span></a>-->
            <!--</li>-->
          </ul>
        </nav>
