	...
	<div class="page-breadcrumb">
		<div class="row">
			<div class="col-12 d-flex no-block align-items-center">
				<h4 class="page-title" style="margin-right:10px;"> Services </h4>
				<span class=" add_button"> <a href="service.php" class="btn btn-sm btn-primary"> Add Services</a></span>
									...
									while ($row = mysqli_fetch_assoc($res)) { ?>
										<tr>
											...
											<td>
												...
												echo "<a target='_blank' href='" . "../../uploads/services/" . $row['image'] . "'><img width='150px' src='" . "../../uploads/services/" . $row['image'] . "'/></a>";
												?>
											</td>
											<td>
												<?php
												...
												echo "<span class='badge1 badge-edit'><a href='service.php?id=" . $row['id'] . "'>Edit</a></span>&nbsp;";
