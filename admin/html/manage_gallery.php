	...
	<div class="page-breadcrumb">
		<div class="row">
			<div class="col-12 d-flex no-block align-items-center">
				...
				<span class=" add_button"> <a href="gallery.php" class="btn btn-sm btn-primary"> Add Gallery</a></span>
									...
									while ($row = mysqli_fetch_assoc($res)) { ?>
										<tr>
											...
											<td>
												...
												echo "<a target='_blank' href='" . "../../uploads/gallery/" . $row['image'] . "'><img width='150px' src='" . "../../uploads/gallery/" . $row['image'] . "'/></a>";
												?>
											</td>
											<td>
												<?php
												...
												echo "<span class='badge1 badge-edit'><a href='gallery.php?id=" . $row['id'] . "'>Edit</a></span>&nbsp;";
