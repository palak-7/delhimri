...
if (isset($_GET['type']) && $_GET['type'] != '') {
	...
	if ($type == 'status') {
		...
		$update_status_sql = "update newslatter set status='$status' where id='$id'";
		mysqli_query($con, $update_status_sql);
	}

	if ($type == 'delete') {
		$id = get_safe_value($con, $_GET['id']);
		$delete_sql = "delete from newslatter where id='$id'";
	...
	<div class="page-breadcrumb">
		<div class="row">
			<div class="col-12 d-flex no-block align-items-center">
				<h4 class="page-title" style="margin-right:10px;">Newslatter</h4>
	...
	<div class="container-fluid" style=" height: calc(100vh - 120px);">
		...
		<div class="row">
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						<h4 class="box-title">Newslatter</h4>
