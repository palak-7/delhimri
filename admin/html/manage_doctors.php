...
if (isset($_GET['type']) && $_GET['type'] != '') {
	...
	if ($type == 'status') {
		...
		$update_status_sql = "update doctors set status='$status' where id='$id'";
		mysqli_query($con, $update_status_sql);
	}

	if ($type == 'delete') {
		$id = get_safe_value($con, $_GET['id']);
		$delete_sql = "delete from doctors where id='$id'";
	...
	<div class="page-breadcrumb">
		<div class="row">
			<div class="col-12 d-flex no-block align-items-center">
				<h4 class="page-title" style="margin-right:10px;"> doctors </h4>
				<span class=" add_button"> <a href="doctors.php" class="btn btn-sm btn-primary"> Add doctors</a></span>
									...
									while ($row = mysqli_fetch_assoc($res)) { ?>
										<tr>
											...
											<td>
												...
												echo "<a target='_blank' href='" . "../../uploads/doctors/" . $row['image'] . "'><img width='150px' src='" . "../../uploads/doctors/" . $row['image'] . "'/></a>";
												?>
											</td>
											<td>
												<?php
												...
												echo "<span class='badge1 badge-edit'><a href='doctors.php?id=" . $row['id'] . "'>Edit</a></span>&nbsp;";
