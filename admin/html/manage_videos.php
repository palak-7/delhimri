	...
	<div class="page-breadcrumb">
		<div class="row">
			<div class="col-12 d-flex no-block align-items-center">
				<h4 class="page-title" style="margin-right:10px;"> videos </h4>
				<span class=" add_button"> <a href="videos.php" class="btn btn-sm btn-primary"> Add videos</a></span>
									...
									while ($row = mysqli_fetch_assoc($res)) { ?>
										<tr>
											...
											<td>
												...
												echo "<span class='badge1 badge-edit'><a href='videos.php?id=" . $row['id'] . "'>Edit</a></span>&nbsp;";
