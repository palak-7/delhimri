                    ...
                    <div class="col-xl-3 col-md-6 col-lg-6 d-flex">
                        <div class="helpful-card wow fadeInUp" data-wow-delay="0.0s">
                            ...
                            <div class="helpful-card-caption">
                                ...
                                <p class="caption-para">Quantum Gradients with integrated Panoramic Array system for
                                    homogenous signals over large Field of View.</p>
                                <a href="services.php" class="imp-link">Read More <i
                    ...
                    <div class="col-xl-3 col-md-6 col-lg-6 d-flex">
                        <div class="helpful-card wow fadeInUp" data-wow-delay="0.20s">
                            ...
                            <div class="helpful-card-caption">
                                ...
                                <p class="caption-para">Advanced abdominal imaging with HASTE sequences for MRCP & MR
                                    Urography.</p>
                                <a href="services.php" class="imp-link">Read More <i
                                        class="ri-arrow-right-up-line"></i></a>
                            </div>
                    ...
                    <div class="col-xl-3 col-md-6 col-lg-6 d-flex">
                        <div class="helpful-card wow fadeInUp" data-wow-delay="0.30s">
                            ...
                            <div class="helpful-card-caption">
                                ...
                                <p class="caption-para">Sonography, Color Doppler, Digital X-Ray, and Dexa Scan
                                    available for a full range of radiological investigations.</p>
                                <a href="services.php" class="imp-link">Read More <i
                                        class="ri-arrow-right-up-line"></i></a>
                            </div>
                            <div class="number-watermark">
                ...
                <div class="row justify-content-between">
                    <div class="col-lg-6 my-auto">
                        ...
                        <div class="section-tittle mb-35">
                            ...
                            <p class="pera-subtitle mb-15">
                                Delhi MRI Scan, located at M-2, Hauz Khas, New Delhi, is a unit of Sahyog Imaging
                                Company. Our center is equipped with state-of-the-art imaging technology.
                            </p>
                            <p class="pera-subtitle">
                                We offer a comprehensive range of radiological services including high-resolution
                                imaging, advanced stroke detection, and complete abdominal imaging.
                            </p>
                        </div>
                                ...
                                <div class="col-lg-10 mb-20">
                                    <div class="d-flex gap-20">
                                        ...
                                        <div class="info-content">
                                            ...
                                            <p class="pera">Featuring Siemens Magnetom Spectra 3 Tesla MRI and CT Scan
                                                32 Slice Somatom Go Now.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-10 mb-20">
                                    <div class="d-flex gap-20">
                                        ...
                                        <div class="info-content">
                                            ...
                                            <p class="pera">Led by Dr. Vinay Guglany and Dr. Raj Kumar Meena,
                                                experienced in advanced radiology.</p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-5">
                        <div class="position-relative h-100">
                            <div>
                                <img class="w-100 d-none d-lg-block" src="assets/images/gallery/aboutaf.png"
                                    alt="image">
                            </div>
                        </div>
                    </div>
          ...
          while ($row = mysqli_fetch_assoc($res)) { ?>
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 view-wrapper">
                        <div class="single-team h-calc">
                            <div class="team-img">
                                <a href="volunteer-details.php" class="">
                            ...
                            <div class="accordion" id="accordionExample">
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body">
                                            The doctors at Delhi MRI Scan are highly qualified and experienced in their
                                            specialties. They possess extensive knowledge about various tests and
                                            procedures, ensuring high-quality patient care.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            Our diagnostic center uses state-of-the-art equipment and advanced
                                            technology to carry out various scans and tests. This ensures precision and
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseThree" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            Proper hygiene is maintained at Delhi MRI Scan. Our staff ensures all safety
                                            rules are followed meticulously while performing tests on patients.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseFour" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            Delhi MRI Scan offers a wide range of tests, including MRI and CT scans. Our
                                            commitment to quality ensures that all services provided meet the highest
                                            standards.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseFive" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            Appointments at Delhi MRI Scan can be scheduled very quickly, either over
                                            the phone or in person, making it convenient for patients.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseSix" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            The test reports at Delhi MRI Scan are highly accurate, providing reliable
                                            results for better diagnosis and treatment.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseSeven" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            At Delhi MRI Scan, accurate results are provided within a short period. Test
                                            reports can often be collected on the same day.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseEight" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            Delhi MRI Scan provides high-quality services and is one of the best
                                            diagnostic centers in South Delhi. Our competitive pricing ensures better
                                            value for all tests compared to other diagnostic centers.
                                        </div>
                                    </div>
                                </div>
                            </div>
